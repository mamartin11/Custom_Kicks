...
<form method="GET" action="{{ route('product.index') }}" class="mb-4">
    <div class="row">
        ...
        <!-- Min Price -->
        <div class="col-md-2">
            <input type="number" name="min_price" class="form-control" placeholder={{ __('product/index.placeholder_minprice') }} 
                value="{{ request()->input('min_price') }}">
        </div>

        <!-- Max Price -->
        <div class="col-md-2">
            <input type="number" name="max_price" class="form-control" placeholder={{ __('product/index.placeholder_maxprice') }} 
                value="{{ request()->input('max_price') }}">
        </div>

        <!-- Size -->
        <div class="col-md-2">
            <input type="float" name="size" class="form-control" placeholder={{ __('product/index.placeholder_size') }} 
        ...
        <div class="col-md-2">
            <select name="brand" class="form-control">
                <option value="">{{ __('product/index.placeholder_brand') }}</option>
        ...
        <!-- Filter button -->
        <div class="col-md-1">
            <button type="submit" class="btn btn-primary">{{ __('product/index.filter_button') }}</button>
        </div>
    </div>
</form>
